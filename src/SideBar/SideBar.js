        ...
        <div className={styles.sidebar}>
          <div className={styles.nav}>
            <nav>
              ...
              <NavLink className={styles.item} to="/heart" onClick={() => handlePageChange('heart')}>
                {activePage === 'heart' ? <img src={HeartActiveIcon} alt="Heart Active" /> : <img src={HeartInactiveIcon} alt="Heart Inactive" />}
              </NavLink>
              <NavLink className={styles.item} to="/collection" onClick={() => handlePageChange('collection')}>
                {activePage === 'collection' ? <img src={CollectionActiveIcon} alt="Collection Active" /> : <img src={CollectionInactiveIcon} alt="Collection Inactive" />}
              </NavLink>
              <NavLink className={styles.item} to="/profile" onClick={() => handlePageChange('profile')}>
                {activePage === 'profile' ? <img src={ProfileActiveIcon} alt="Profile Active" /> : <img src={ProfileInactiveIcon} alt="Profile Inactive" />}
              </NavLink>
              <NavLink className={styles.item} to="/setting" onClick={() => handlePageChange('setting')}>
                {activePage === 'setting' ? <img src={SettingActiveIcon} alt="Setting Active" /> : <img src={SettingInactiveIcon} alt="Setting Inactive" />}
              </NavLink>
            </nav>
          </div>
          <div className={styles.item}>
