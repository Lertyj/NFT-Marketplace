...
export function CreatorComponent({avatar,nickname,projects,value}){
    return(
        <div className={classes.wrapper}>
            ...
            <button onClick={() => {return false}} type="button" className={classes.button}>{value}</button>
            </div>
        </div>
    )
}
    ...
    return(
        <div className={styles.wrapper}>
            ...
            <div className={styles.content}>
                <ul>
                    <li><CreatorComponent avatar={avatar} nickname="Papaya" projects="60 items" value="Follow"/></li>
                    <li><CreatorComponent avatar={avatar} nickname="Papaya" projects="60 items" value="Follow"/></li>
                    <li><CreatorComponent avatar={avatar} nickname="Papaya" projects="60 items" value="Follow"/></li>
                    <li><CreatorComponent avatar={avatar} nickname="Papaya" projects="60 items" value="Follow"/></li>
                </ul>
