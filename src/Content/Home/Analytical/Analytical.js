        ...
        <div className={classes.card}>
            <div className={classes.content}>
                <div className={classes.information}>
                    <div className={classes.img} style={imgStyle}><img src={img} alt={industry}/>
                    </div>
        ...
        <div className={styles.graphics}>
            <div className={styles.bids}>
                ...
                <div className={styles.cards}>
                    <Card img={wallet} number="24K" industry="Artworks" percent="+168.001%" color="#6F4FF2" pColor="#50BB25"/>
                    <Card img={art} number="89" industry="Auction" percent="-168.001%" color="#DC3546" pColor="#DC3546"/>
                    <Card img={wallet} number="82K" industry="Creators" percent="+168.001%" color="#50BB25" pColor="#50BB25"/>
                </div>
            </div>
